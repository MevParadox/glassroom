      ...
      <div className="w-full max-w-sm text-center space-y-8">
        ...
        <div className="space-y-3">
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-card border border-border rounded-xl font-body text-sm text-foreground hover:bg-secondary/50 transition-colors disabled:opacity-50"
          >
            {isLoading ? (
